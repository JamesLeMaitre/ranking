...
public class DataFormatter<T> {
    ...
    public Formatter<List<T>[]> renderDataArrays(boolean status, List<T>[] data, String message){
        Formatter formatter = new Formatter<List<T>>();
        formatter.setStatus(status);
        formatter.setData(data);
        formatter.setMessage(message);
    ...
    public  Formatter<Double>[] renderDoubleDataArrays(boolean status, Double[] data, String message){
        Formatter formatter = new Formatter<>();
        formatter.setStatus(status);
        formatter.setData(data);
        formatter.setMessage(message);
